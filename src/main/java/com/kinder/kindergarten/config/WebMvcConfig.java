...
public class WebMvcConfig implements WebMvcConfigurer {
  ...
  @Value("${uploadPathMoney2}")
  String uploadPathMoney;
  ...
  public void addResourceHandlers(ResourceHandlerRegistry registry){
    ...
    registry.addResourceHandler("/upload/**") //웹 브라우저에 입력하는 url에 /images로 시작하는 경우 uploadPath에 폴더에서 파일을 읽어오도록 설정한다.
            .addResourceLocations(uploadPathMoney);  //로컬 컴퓨터에 저장된 파일을 읽어올 root 경로 지정
  }
